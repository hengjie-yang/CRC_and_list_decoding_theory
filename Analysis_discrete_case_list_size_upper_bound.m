...
%     vanilla_covering_sphere_bound_cond_exp_list_size(w+1) = ...
%         1+sum(weight_spectrum_high_rate(1:2*threshold+1)) - sum(weight_spectrum_low_rate(1:2*threshold+1));
% vanilla_covering_sphere_bound_cond_exp_list_size(w+1) = ...
...
path = './Simulation_results/';
load([path, '110420_180539_sim_list_sizes_hard_ZTCC_13_17_CRC_17_k_4.mat'], 'Ave_list_sizes', 'snr_dBs');
