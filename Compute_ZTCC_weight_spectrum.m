function weight_node = Compute_ZTCC_weight_spectrum(constraint_length, code_generator, N)

% 
%   This function computes the weight spectrum of a given ZTCC of length N
%
%   Inputs:
...
%
%   Outputs:
%       1)weight_node: consisted of the weight_spectrum and the polynomial
%       expression.
%
...
file_name = ['weight_node_ZTCC_',code_string,'_N_',num2str(N),'.mat'];
