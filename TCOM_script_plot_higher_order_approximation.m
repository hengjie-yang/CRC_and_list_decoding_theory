...
load([path, '031221_171227_cond_exp_list_sizes_soft_ZTCC_561_753_CRC_2317_k_64.mat'],'etas',...
    'Ave_cond_list_sizes','P_UE_mins', 'P_UE_maxs', 'P_NACK_mins', 'P_NACK_maxs');
Ave_cond_list_sizes_CRC_2317_k_64 = Ave_cond_list_sizes;
convergence_val = Ave_cond_list_sizes(end);
...
Ethan_approximations = 1 - P_UE_maxs + P_UE_maxs*convergence_val;
...
semilogy(etas, Ethan_approximations, '-.', 'Color', '#D95319');
